...
$modulePath = Join-Path $testRoot 'm0198.psm1'
$decisionFixturePath = Join-Path $fixtureRoot 'j0197.json'
$targetSchemaPath = Join-Path $fixtureRoot 'j0201.json'
$targetExamplePath = Join-Path $fixtureRoot 'j0202.json'
$ownerLabTargetExamplePath = Join-Path $fixtureRoot 'j0200.json'
