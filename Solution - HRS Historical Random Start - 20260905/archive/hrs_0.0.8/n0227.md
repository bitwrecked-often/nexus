...
1. `n0008.md` for product behavior and
   hard safety boundaries.
2. `n0009.md` for phase order and gates.
3. This manifest for launcher UX comparison and evolution.
4. `evidence/n0012.md` for observed current-state
   evidence.
...
| --- | --- | --- |
| `ui/p0159.ps1` | Day 2 project-shell baseline | `886CA2D1C20C3BD5B653974C1349FB9A162587DCE3076DE28C5FFBC2D9AB36A6` |
...
| `../7dtd_wasteland_animal_population_tuning_files/ui/7DTD_WastelandAnimalPopulationTuning_Tool.ps1` | Completed first-mod reference | `168F333A8D5A4C9CA150A40205DF2E148207DE2D1D3F978E7884E45B7C425FEF` |
...
| --- | --- | ---: | ---: | --- |
| `ui/p0159.ps1` | `0.0.7-preview` | 65,815 | 1,478 | `8AF32340DFECE64250FE053F0A188A1FFC9F58B3F361EBECF283FF4F8F468E5D` |
...
in `n0009.md`. UI states and capability
