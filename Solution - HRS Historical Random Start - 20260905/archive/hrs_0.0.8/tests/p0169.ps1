...
function New-HrsDeploymentFixture {
    ...
    Write-HrsFixtureText -Path (Join-Path $payloadRoot 'ModInfo.xml') -Text '<xml><Name value="mod" /></xml>'
...
try {
    ...
    Invoke-HrsCase 'DEPLOY-MANIFEST-001-construction-and-hashes' {
        ...
        Assert-HrsEqual $manifest.releaseFolder 'mod' 'Release folder differed.'
