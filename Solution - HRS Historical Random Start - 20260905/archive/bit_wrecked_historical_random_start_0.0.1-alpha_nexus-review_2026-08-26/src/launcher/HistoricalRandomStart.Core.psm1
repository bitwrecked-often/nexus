...
function Get-HrsPolicyDigestInput {
    param(
        ...
        [Parameter(Mandatory = $true)] [ValidateSet('Standard', 'Random')] [string] $Mode,
...
function Get-HrsManagerStatePaths {
    ...
    $support = [System.IO.Path]::Combine($root, 'Support_Files_Do_Not_Edit')
