@echo off
rem Bit Wrecked Historical Random Start - 0.0.5 alpha-tech-demo manager
rem Copyright (C) 2026 Bit Wrecked contributors
rem SPDX-License-Identifier: GPL-3.0-or-later
setlocal DisableDelayedExpansion
set "TOOL_PATH=%~dp0Support_Files_Do_Not_Edit\HistoricalRandomStart_Tool_2026-08-21.ps1"
