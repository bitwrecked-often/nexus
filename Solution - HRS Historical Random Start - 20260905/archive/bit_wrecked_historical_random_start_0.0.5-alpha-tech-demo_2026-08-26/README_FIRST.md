...
3. `0.0.5_ALPHA_TECH_DEMO_START_HERE.md`
4. `DOCUMENT_ROUTING.md`
5. `src/runtime/RUNTIME_DEVELOPMENT_AND_STATION_MIGRATION_MANIFEST.md`
6. `CURRENT_SITUATIONAL_AWARENESS.md`
7. `2026-08-26_0.0.5_ALPHA_TECH_DEMO_LARGER_MODEL_EXECUTION_MANIFEST.md`
8. `ALPHA_CORE_EXECUTION_PACKET_0.0.1.md`
9. `2026-08-13_historical_random_start_manifest.md`
10. `2026-08-13_historical_random_start_plan.md`
11. `DEV_TEST_AND_SOFTWARE_ASSURANCE_CONTRACT_0.0.1.md`
12. `CHANGELOG.md`
