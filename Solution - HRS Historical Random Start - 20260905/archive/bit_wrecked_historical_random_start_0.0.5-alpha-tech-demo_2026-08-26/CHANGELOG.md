...
- Added `2026-08-26_0.0.5_ALPHA_TECH_DEMO_LARGER_MODEL_EXECUTION_MANIFEST.md`
...
- Added `ALPHA_CORE_EXECUTION_PACKET_0.0.1.md` and marked bounded staged
...
- Added `AI_IMPLEMENTATION_REQUIREMENTS_AND_PLATFORM_GUIDE.md` with measured
...
- Kept build/output staging external and restricted any future runtime copy to
  the exact owned `Mods/BitWrecked_HistoricalRandomStart_DEV/` folder after
...
- Added `OPENSSF_READINESS.md`, `SECURITY.md`, `CONTRIBUTING.md`,
...
- Added the clickable `7DTD_HistoricalRandomStart.bat` design-shell launcher.
...
- Changed no launcher code, gameplay payload, live game file, Harmony file,
  save, world, XML, DLL, or live `Mods` content.
- Added `CURRENT_SITUATIONAL_AWARENESS.md` to preserve the accepted approach,
