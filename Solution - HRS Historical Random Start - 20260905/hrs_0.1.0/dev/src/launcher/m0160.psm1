...
function Get-HrsCopyCatalog {
    return @(
        ...
        [pscustomobject]@{ Key='ArrivalBiome'; Label='Protect arrival biome hazard'; Tooltip='Suppress only the hazard family for the Random arrival biome'; AccessibleDescription='Optional exact-game protection for the character arrival biome; other biome hazards remain active'; Essential=$false; Placement='Control' },
