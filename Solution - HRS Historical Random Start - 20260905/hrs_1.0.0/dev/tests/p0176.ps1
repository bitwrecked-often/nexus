...
Assert-True ($manager.Contains("394C9EF2C2AAA8E30A7268DFA7A33E1CBED80975A4779C6327F6DAE4A45DF72E")) 'main runtime hash is pinned'
Assert-True ($manager.Contains("ED14DB4450CB449B3628539BF3D3A9998D9D1709B141D80367C47641C1E5C419")) 'ModInfo hash is pinned'
