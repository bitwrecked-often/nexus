...
1. For feature history or framework reasoning, read `../docs/n0243.md`. It is
   the chronological route through the failed methods, working Snow/trader
   examples, game-version observations, and current 1.2.0 continuation.
2. For carousel work, read
...
3. Read this file only for broader product, scouting, or release context.
4. Read `2026-08-30_spawn_candidates.md` for current observations and the next
   physical batch.
5. Read `navezgane_poi_catalog_v3.2-b9.meta.json` for catalog provenance.
6. Query only the required rows from `navezgane_poi_catalog_v3.2-b9.csv`; do
   not place the entire catalog into the model context unless necessary.
7. Read `../../../DEVELOPMENT_CYCLE_DOCTRINE.md` when making a new development
   decision.
8. Read `../docs/n0235.md` before opening a new version lane or QA cycle.
9. Read `../docs/n0238.md` when historical design reasoning is needed for the
