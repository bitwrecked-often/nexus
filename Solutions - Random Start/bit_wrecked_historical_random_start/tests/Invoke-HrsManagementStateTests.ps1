...
$corePath = Join-Path $projectRoot 'src\launcher\HistoricalRandomStart.Core.psm1'
$managementPath = Join-Path $projectRoot 'src\launcher\HistoricalRandomStart.Management.psm1'
...
[void][System.IO.Directory]::CreateDirectory((Join-Path $testRoot 'Support_Files_Do_Not_Edit'))
